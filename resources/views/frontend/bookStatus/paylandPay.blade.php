  ...
  <body>
    ...
    <div class="contenedor">
      <h3 class="tpv">TPV</h3>
        ...
        <a class="logo" href="/">
          <img src="{{ assetV('img/riad/logo_riad.png') }}" alt="Riad">
        </a>
