...
<div class="row">
    ...
    <form role="form" action="{{ url('/admin/specialSegments/create') }}" method="post">
        ...
        <div class="col-md-3 col-xs-12">
            <input type="number" class="form-control" name="minDays" placeholder="Minimo días" required="" aria-required="true" aria-invalid="false">
        </div>
        <div class="col-md-3 col-xs-12">
