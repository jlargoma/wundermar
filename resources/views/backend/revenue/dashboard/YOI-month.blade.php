...
foreach ($aux as $k=>$v):
  ...
  $sSS = \App\Settings::findOrCreate('revenue_disponibilidad_'.$year.'_'.$month, $k);
  ...
  <table class="table table-resumen summary">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="first-col"></td>
        <td><input class="editable" data-k="p_n_hab" {!! $params !!} value="{{$p_hab}}"></td>
        <td>{{$p_habPercent}}%</td>
        <td><input class="editable" data-k="p_med_pvp" {!! $params !!} value="{{$p_med_pvp}}"></td>
        <td><input class="editable" data-k="p_pvp" {!! $params !!} value="{{$p_pvp}}"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="first-col"></td>
        <td><input class="editable" data-k="foresc_n_hab" {!! $params !!} value="{{$f_hab}}"></td>
        <td>{{$p_habPercent}}%</td>
        <td><input class="editable" data-k="foresc_med_pvp" {!! $params !!} value="{{$f_med_pvp}}"></td>
        <td><input class="editable" data-k="foresc_pvp" {!! $params !!} value="{{$f_pvp}}"></td>
      </tr>
      <tr>
        <td class="static text-left">Diferencial</td>
        <td class="first-col"></td>
