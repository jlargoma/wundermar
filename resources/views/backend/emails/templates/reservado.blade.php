Hola {customer_name} hemos bloqueado parcialmente un apartamento en respuesta a tu solicitud:<br/><br/>

<h2><u>Pago de la reserva</u></h2>
<b>Dispones de un plazo de 4 horas para realizar el pago de la señal </b>
<b style="color: red">{percent}% del total =  {mount_percent} €</b>
a través de nuestra pasarela de pago para tarjetas.<br><br>
	<a href="{urlToPayment}">PAGA AHORA</a>
<br><br>
...
Consulta nuestras condiciones de contratación <a href="#">aquí</a></b><br><br>
<hr><br>
Nombre: <strong>{customer_name}</strong><br />
Tel&eacute;fono: <strong><a href="tel:{customer_phone}">{customer_phone}</a></strong><br />
Apartamento: <strong>{room} {room_type}</strong><br />
Email: <strong>{customer_email}</strong><br />
Fecha Entrada: <strong>{date_start}</strong><br />
Fecha Salida: <strong>{date_end}</strong><br />
Noches: <strong>{nigths}</strong><br />
Ocupantes: <strong>{pax}</strong><br />
Suplemento lujo: <strong>{sup_lujo} &euro;</strong><br />
Comentarios: <strong>{comment}</strong><br />
El precio te incluye todo, piscina climatizada, gimnasio, taquilla guarda esquíes.<br>
<br>
